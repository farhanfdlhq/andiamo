...
import { Batch, Region } from "../types"; // Menggunakan tipe dari proyek Anda
import LoadingSpinner from "../components/LoadingSpinner";
import ImageGallery from "../components/ImageGallery";
import { WhatsAppIcon, ChevronLeftIcon, InfoIcon } from "../components/icons"; // Pastikan InfoIcon diimpor
import { useAuth } from "../hooks/useAuth"; // Jika diperlukan untuk settings (tidak digunakan di referensi ini)
import {
  PRIMARY_COLOR,
  BUTTON_COLOR,
  BUTTON_TEXT_COLOR,
...
const BatchDetailPage: React.FC = () => {
  const { id } = useParams<{ id: string }>(); // Tetap menggunakan 'id' sesuai App.tsx Anda
  ...
  // const { settings } = useAuth(); // Tidak digunakan di referensi ini, bisa dihapus jika tidak ada logika WhatsApp khusus
    ...
    <div className="font-inter container mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
      ...
      <div className="bg-white p-6 sm:p-8 rounded-xl shadow-xl">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          <div>
            {/* Menggunakan ImageGallery dengan imagePaths yang sudah ada */}
          ...
          <div className="flex flex-col">
            ...
            {/* Deskripsi Singkat jika ada, lalu Deskripsi utama */}
            ...
            {batch.whatsappLink && !isClosed && (
              <div className="mt-auto pt-6 border-t border-gray-200">
                <a
                  href={batch.whatsappLink} // Menggunakan whatsappLink langsung dari batch
                  target="_blank"
                ...
                >
                  ...
                  Hubungi Jastiper via WhatsApp {/* Teks dari referensi */}
                </a>
              </div>
            )}
            {isClosed &&
              !batch.whatsappLink && ( // Jika ditutup dan tidak ada link WA spesifik batch
                <div className="mt-auto pt-6 border-t border-gray-200">
